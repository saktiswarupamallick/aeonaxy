      ...
      <div className="flex flex-col justify-center items-center h-screen overflow-auto">
        <div className="flex flex-col lg:flex-row justify-center items-center w-full max-w-screen-lg">
          ...
          <div className="w-full lg:w-1/2 px-8">
            ...
            <p className="italic  text-sm md:text-base mb-4">"Mathematics is not just about numbers and equations; it's about understanding patterns, uncovering hidden truths, and exploring the beauty of logic in the universe."</p>
